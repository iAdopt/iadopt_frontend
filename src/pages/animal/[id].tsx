...
import comarcas from '../../common/utils/comarcas/comarcas.json';
                    ...
                    <>
                        ...
                        <div className={styles.sectionCenter}>
                            <div className={styles.center}>
                                ...
                                <p><b>Dirección: </b>{ Object.entries(comarcas).map(comarca => (storeSingleAnimal.location && parseInt(comarca[0]) == storeSingleAnimal.location) ? comarca[1] : '')}</p>
                                <br/>
                                <iframe
